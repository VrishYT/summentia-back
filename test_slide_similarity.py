...
def test_squashing_4():
    result = comparator.is_similar(
        'Slides - Module 2 - K-NN and Decision Trees/Slides - Module 2 - K-NN and Decision Trees-29.png',
...
def test_squashing_6():
    result = comparator.is_similar(
        'Slides - Module 2 - K-NN and Decision Trees/Slides - Module 2 - K-NN and Decision Trees-31.png',
...
def test_squashing_9():
    result = comparator.is_similar(
        'Slides - Module 2 - K-NN and Decision Trees/Slides - Module 2 - K-NN and Decision Trees-38.png',
...
def test_squashing_11():
    result = comparator.is_similar(
        'Slides - Module 2 - K-NN and Decision Trees/Slides - Module 2 - K-NN and Decision Trees-44.png',
...
def test_squashing_12():
    result = comparator.is_similar(
        'Slides - Module 2 - K-NN and Decision Trees/Slides - Module 2 - K-NN and Decision Trees-53.png',
...
def test_squashing_15():
    result = comparator.is_similar(
        'Slides - Module 2 - K-NN and Decision Trees/Slides - Module 2 - K-NN and Decision Trees-58.png',
...
def test_squashing_17():
    result = comparator.is_similar(
        'Slides - Module 2 - K-NN and Decision Trees/Slides - Module 2 - K-NN and Decision Trees-74.png',
...
def test_squashing_19():
    result = comparator.is_similar(
        'Slides - Module 2 - K-NN and Decision Trees/Slides - Module 2 - K-NN and Decision Trees-77.png',
...
def test_squashing_22():
    result = comparator.is_similar(
        'Slides - Module 2 - K-NN and Decision Trees/Slides - Module 2 - K-NN and Decision Trees-92.png',
